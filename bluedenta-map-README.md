...
An interactive clinic finder built for [Bluedenta](https://www.bluedenta.de), a dental supply platform. Users can search for dental practices across Germany and locate them on an interactive map. Built independently as part of my work at Cubular.

## Screenshots

<img src="assets/screenshot-desktop.jpg" alt="Bluedenta Map – Desktop" width="100%" />

<img src="assets/screenshot-mobile.jpg" alt="Bluedenta Map – Mobile" width="360" />
